import { PICK_FRONT_DOCK_TOTE, PICK_FRONT_MORE_ITEM_SCAN, PICK_FRONT_PPTL_PRESS, PICK_FRONT_SCAN_OR_WAIT_FOR_CONTAINER, PICK_FRONT_TTP_ITEM_SCAN, PICK_FRONT_UNDOCK_TOTE, PICK_FRONT_WAITING_FOR_MSU, UD_PUT_FRONT_ENTITY_SCAN, UD_PUT_FRONT_PLACE_ITEMS_IN_RACK, UD_PUT_FRONT_TOTE_SCAN, UD_PUT_TOTE_INDUCTION } from "./screenIds";
...
export const VALID_URLS = ['/pick', '/login', '/put', '/put-back', '/put-front', '/scan-pallet', '/scan-tote', '/scan-entity', '/place-entity', '/pick-back'];
